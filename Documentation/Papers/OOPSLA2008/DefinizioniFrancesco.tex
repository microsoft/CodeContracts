...
\newcommand{\abs}[1]{\ensuremath{\bar{#1}}}
...
\newcommand{\aenv}{\ensuremath{\overline{\env}}}
...
\newcommand{\funzioneDue}[2]{\ensuremath{[#1 \mapsto #2]}}
...
\newcommand{\dom}[1]{\insieme{#1}}
  ...
  % Dominio astratto
\newcommand{\adom}[1]{\ensuremath{\abs{\mathsf{#1}}}}
...
\newcommand{\Pentagons}{\dom{Pntg}}
\newcommand{\LessThan}{\dom{LT}}
\newcommand{\Null}{\dom{Null}}
\newcommand{\SV}{\dom{SV}}
\newcommand{\Stripes}{\dom{Strp}}
\newcommand{\Karr}{\dom{LinEq}}
\newcommand{\Strings}{\dom{StrVal}}
...
\newcommand{\gammaHeap}{\ensuremath{\gamma_\dom{H}}}
...
\newcommand{\Foxtrot}{\ensuremath{\mathtt{FoxTrot}}}
\newcommand{\Net}{\ensuremath{\mathtt{.NET}}}
\newcommand{\net}{\Net}
\newcommand{\NET}{\Net}
...
% SV
\newcommand{\sv}{\ensuremath{\mathsf{sv}}}
...
\newcommand{\svfor}[2]{\ensuremath{\varsigma_{#1}}(\code{#2})}

\newcommand{\path}[1]{\ensuremath{\stackrel{\rightarrow}{\code{#1}}}}


\newcommand{\iless}{\ensuremath{\less_i}}
\newcommand{\ijoin}{\ensuremath{\join_i}}
\newcommand{\imeet}{\ensuremath{\meet_i}}
\newcommand{\iwidening}{\ensuremath{\widening_i}}
\newcommand{\itop}{\ensuremath{\atp_i}}
\newcommand{\ibot}{\ensuremath{\abot_i}}

\newcommand{\bless}{\ensuremath{\less_b}}
\newcommand{\bjoin}{\ensuremath{\join_b}}
\newcommand{\bmeet}{\ensuremath{\meet_b}}
\newcommand{\bwidening}{\ensuremath{\widening_b}}
\newcommand{\btop}{\ensuremath{\atp_b}}
\newcommand{\bbot}{\ensuremath{\abot_b}}

\newcommand{\sless}{\ensuremath{\less_s}}
\newcommand{\sjoin}{\ensuremath{\join_s}}
\newcommand{\smeet}{\ensuremath{\meet_s}}
\newcommand{\swidening}{\ensuremath{\widening_s}}
\newcommand{\sTop}{\ensuremath{\atp_s}}
\newcommand{\sbot}{\ensuremath{\abot_s}}

\newcommand{\pless}{\ensuremath{\less_p}}
\newcommand{\pjoin}{\ensuremath{\join_p}}
\newcommand{\pmeet}{\ensuremath{\meet_p}}
\newcommand{\pwidening}{\ensuremath{\widening_p}}
\newcommand{\ptop}{\ensuremath{\atp_p}}
\newcommand{\pbot}{\ensuremath{\abot_p}}
...
\newcommand{\StringAbstraction}{\ensuremath{\overline{\code{String}}}}
\newcommand{\exactStr}[1]{\ensuremath{\mathsf{str}(\mathit{#1})}}
\newcommand{\prefixStr}[1]{\ensuremath{\mathsf{pre}(\mathit{#1})}}
\newcommand{\charsStr}[1]{\ensuremath{\mathsf{chrs}(\mathit{#1})}}

\newcommand{\strLess}{\ensuremath{\less_\code{S}}}

\newcommand{\regione}[2]{\ensuremath{\tupla{\code{#1}, #2}}}
\newcommand{\maexp}{\ensuremath{\code{maExp}}}

\newcommand{\WB}[1]{\ensuremath{\code{WB}(\code{#1})}}

\newcommand{\MSIL}{\code{MSIL}}
\newcommand{\uMSIL}{\code{uMSIL}}

\newcommand{\Cdom}{\dom{C}}

\newcommand{\tvNot}[1]{\ensuremath{!(#1)}}

%%% Local Variables:
%%% mode: plain-tex
%%% TeX-master: "ILAnalysis"
%%% End:
...
\newcommand{\EvalA}{\ensuremath{\overline{\Eval}}}
\newcommand{\AllocA}{\ensuremath{\overline{\Alloc}}}

%%begin Pietro
\newcommand{\bigdivision}[2]{\frac{\displaystyle #1}{\displaystyle #2}}
\newcommand{\eval}[2]{\Eval(\code{#1},#2)}
\newcommand{\alloc}[2]{\Alloc(\code{#1},#2)}

\newcommand{\evala}[2]{\EvalA(\code{#1},#2)}
\newcommand{\alloca}[2]{\AllocA(\code{#1}, #2)}
\newcommand{\scrivi}[4]{\ensuremath{\mathsf{write}\allowbreak(#1, \allowbreak #2,\allowbreak #3,\allowbreak #4)}}
\newcommand{\leggi}[3]{\ensuremath{\mathsf{read}\allowbreak(#1, \allowbreak #2,\allowbreak #3)}}


\newcommand{\otherwise}{\mathtt{otherwise}}

\newcommand{\variables}{\Vars}
\newcommand{\addresses}{\ensuremath{\mathtt{Add}}}
\newcommand{\types}{\mathtt{Type}}
\newcommand{\program}{\mathtt{Prog}}
\newcommand{\statement}{\mathtt{St}}
\newcommand{\WBonly}{\ensuremath{\code{WB}}}
\newcommand{\naturalnumbers}{\ensuremath{\mathbb{N}}}
\newcommand{\Bytes}{\ensuremath{\code{Byte}}}
\newcommand{\sizeof}[1]{\mathsf{sizeof}(\code{#1})}
\newcommand{\domain}[1]{\mathsf{dom}(#1)}
\newcommand{\assignfun}[3]{\mathsf{assign}(\code{#1},\allowbreak \code{#2}, \allowbreak\el{#3})}
\newcommand{\checkfun}[2]{\mathsf{check}(\code{#1},\allowbreak \el{#2})}
\newcommand{\dropfun}[2]{\mathsf{drop}(#1,#2)}
\newcommand{\normalize}[1]{\mathsf{normalize}(#1)}
\newcommand{\expressions}{\mathsf{Exp}}
\newcommand{\true}{\mathtt{true}}
\newcommand{\false}{\mathtt{false}}
\newcommand{\var}[1]{\code{#1}}
\newcommand{\const}[1]{\ensuremath{#1}}
\newcommand{\expr}[1]{\code{#1}}

\newcommand{\concrete}[1]{\ensuremath{\mathsf{#1}}}
\newcommand{\abstrf}[1]{\ensuremath{\abs{\concrete{#1}}}} %First level of abstraction
\newcommand{\Adomf}{\adom{C}}
\newcommand{\abstrs}[1]{\abs{\el{#1}}} %Second level of abstraction
\newcommand{\Adoms}{\dom{D}_2}

\newcommand{\dontknow}{\ensuremath{\Omega_?}}

\newcommand{\plane}{\ensuremath{\mathcal{R}}}
\newcommand{\points}{\ensuremath{\mathcal{A}}}
