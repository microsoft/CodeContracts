...
namespace Microsoft.Cci.Analysis
{
    ...
    {
        private readonly CciILCodeProvider _parent;
        internal readonly CciMetadataDecoder mdDecoder;
        private readonly IContractAwareHost _host;
        ...
        private static string TypeName(ITypeReference type)
        {
        ...
        private static bool HasAttributeWithName(IEnumerable<ICustomAttribute> attributes, string expected)
        {
            Contract.Requires(attributes != null);
        ...
        public Result AccessRequires<Data, Result>(MethodReferenceAdaptor methodAdaptor, ICodeConsumer<LocalDefAdaptor, IParameterTypeInformation, MethodReferenceAdaptor, FieldReferenceAdaptor, TypeReferenceAdaptor, Data, Result> consumer, Data data)
        {
            ...
            ThisSubstituter ts = new ThisSubstituter(_host, pDef);
            ...
            return consumer.Accept(_parent.ContractProvider, new CciContractPC(requires), data);
        }
        ...
        public Result AccessEnsures<Data, Result>(MethodReferenceAdaptor methodAdaptor, ICodeConsumer<LocalDefAdaptor, IParameterTypeInformation, MethodReferenceAdaptor, FieldReferenceAdaptor, TypeReferenceAdaptor, Data, Result> consumer, Data data)
        {
            ...
            return consumer.Accept(_parent.ContractProvider, new CciContractPC(ensures), data);
        }
        ...
        public Result AccessModelEnsures<Data, Result>(MethodReferenceAdaptor methodAdaptor, ICodeConsumer<LocalDefAdaptor, IParameterTypeInformation, MethodReferenceAdaptor, FieldReferenceAdaptor, TypeReferenceAdaptor, Data, Result> consumer, Data data)
        {
            ...
            return consumer.Accept(_parent.ContractProvider, new CciContractPC(modelEnsures), data);
        }

        private readonly Dictionary<TypeReferenceAdaptor, IParameterTypeInformation> _thisParameterFor = new Dictionary<TypeReferenceAdaptor, IParameterTypeInformation>();
        ...
        public Result AccessInvariant<Data, Result>(TypeReferenceAdaptor typeAdaptor, ICodeConsumer<LocalDefAdaptor, IParameterTypeInformation, MethodReferenceAdaptor, FieldReferenceAdaptor, TypeReferenceAdaptor, Data, Result> consumer, Data data)
        {
            ...
            if (!_thisParameterFor.TryGetValue(typeAdaptor, out thisPar))
            {
                ...
                _thisParameterFor[typeAdaptor] = par;
                thisPar = par;
            }
            ...
            return consumer.Accept(_parent.ContractProvider, new CciContractPC(invariants), data);
        }
        ...
        public IMethodContract/*?*/ GetMethodContract(IMethodReference method)
        {
            ...
            var mc = ContractHelper.GetMethodContractFor(_host, method.ResolvedMethod);
            if (mc != null)
            {
        ...
        {
            readonly private string _methodName;
            private int _number = 0;
            private readonly Dictionary<WeakReference, string> _table;
            ...
            {
                _number++;
                var name = _methodName + _number.ToString();
                _table[new WeakReference(anonymousDelegate)] = name;
        ...
        public ITypeContract/*?*/ GetTypeContract(ITypeReference typeReference)
        {
            ...
            IContractProvider lcp = _host.GetContractExtractor(unit.UnitIdentity);
      ...
      IMethodCodeProvider<CciContractPC, LocalDefAdaptor, IParameterTypeInformation, MethodReferenceAdaptor, FieldReferenceAdaptor, TypeReferenceAdaptor, CciExceptionHandlerInfo>
    {
        ...
        /// </summary>
        private object _contractProviderVisitor;
      ...
      return query.Atomic(data, label);
        ...
        internal class ThisReferenceFinder : CodeTraverser
        {
            public static IParameterTypeInformation/*?*/ FindThisReference(IAnonymousDelegate iAnonymousDelegate)
            {
                ...
                return t._thisReference;
            }
            private IParameterTypeInformation/*?*/ _thisReference;
            private ThisReferenceFinder() { }
            public override void TraverseChildren(IParameterDefinition parameterDefinition)
            {
                if (_thisReference == null && parameterDefinition.Index == ushort.MaxValue)
                {
                    _thisReference = parameterDefinition;
                }
            }
        }
          ...
          where Visitor : ICodeQuery<CciContractPC, LocalDefAdaptor, IParameterTypeInformation, MethodReferenceAdaptor, FieldReferenceAdaptor, TypeReferenceAdaptor, Data, Result>
        {
            ...
            if (expression != null || stmt != null)
            {
                ContractProviderVisitor<Data, Result, Visitor> cpv
                  = _contractProviderVisitor as ContractProviderVisitor<Data, Result, Visitor>;
                if (cpv == null)
                {
                    //Console.WriteLine("generating a new one");
                    _contractProviderVisitor = cpv =
     ...
     where Visitor : IVisitMSIL<CciContractPC, LocalDefAdaptor, IParameterTypeInformation, MethodReferenceAdaptor, FieldReferenceAdaptor, TypeReferenceAdaptor, Unit, Unit, Data, Result>
    {
        ...
        private readonly CciContractProvider _parent;
        ...
        {
            this.result = visitor.Call(pc, _parent.GetTypeFromHandleAdaptor, false, false, new TypeList(Enumerable<IParameterTypeInformation>.Empty),
        ...
        public void Visit(IMethodCall methodCall)
        {
            ...
            if (methodDefinition is Dummy)
            {
                ...
                var modelMethods = _parent.contractDecoder.ModelMethods(TypeReferenceAdaptor.AdaptorOf(containingType));
        ...
        private void VisitUncheckedConversion(ITypeReference sourceType, ITypeReference targetType)
        {
            ...
            switch (sourceType.TypeCode)
            {
                ...
                default:
                    if (TypeHelper.TypesAreEquivalent(targetType, _parent.host.PlatformType.SystemObject))
                    {
                        this.result = visitor.Box(pc, CciILCodeProvider.Adapt(sourceType), Unit.Value, Unit.Value, data);
                        return;
                    }
                    //TODO: conversion from method to (function) pointer
                    if (!sourceType.IsValueType && !TypeHelper.TypesAreEquivalent(sourceType, _parent.host.PlatformType.SystemObject) && targetType.TypeCode == PrimitiveTypeCode.IntPtr)
                        op = UnaryOperator.Conv_i;
                    else if (TypeHelper.TypesAreEquivalent(sourceType, _parent.host.PlatformType.SystemObject))
                    {
                ...
                case PrimitiveTypeCode.Boolean:
                    {
                        ...
                        if (value)
                        {
                            this.result = visitor.Ldconst(pc, (Int32)1, _parent.mdDecoder.System_Int32, Unit.Value, data);
                            return;
                        }
                        else
                        {
                            this.result = visitor.Ldconst(pc, (Int32)0, _parent.mdDecoder.System_Int32, Unit.Value, data);
                            return;
                        }
                    }
                case PrimitiveTypeCode.Char:
                    // the decompiler introduces char values.
                    {
                        ...
                        this.result = visitor.Ldconst(pc, value, _parent.mdDecoder.System_Int32, Unit.Value, data);
                        return;
                    }
                default:
        ...
        public void Visit(IParameterDefinition parameterDefinition)
        {
            ...
            if (parameterDefinition.Index == ushort.MaxValue)
            {
                ...
                p = _parent.mdDecoder.This(MethodReferenceAdaptor.AdaptorOf(mref));
      ...
      IMethodCodeProvider<CciILPC, LocalDefAdaptor, IParameterTypeInformation, MethodReferenceAdaptor, FieldReferenceAdaptor, TypeReferenceAdaptor, CciExceptionHandlerInfo>
    {
        ...
        private void ObjectInvariant()
        {
            Contract.Invariant(_metaDataDecoder != null);
        ...
        private readonly CodeContractAwareHostEnvironment _host;
        private readonly CciContractDecoder _contractDecoder;
        private readonly CciMetadataDecoder _metaDataDecoder;
        private IPlatformType _platformType;
        private CciContractProvider _contractProvider;
        ...
        private CciILCodeProvider(HostEnvironment host, IPlatformType platformType)
        {
            ...
            _metaDataDecoder = new CciMetadataDecoder(this, host, platformType);
            _contractDecoder = new CciContractDecoder(this, host, _metaDataDecoder);
            _host = host;
        }
        ...
        {
            get { if (_platformType == null) _platformType = _host.PlatformType; return _platformType; }
        }
        ...
        internal CciContractProvider ContractProvider // MB: I do not know how often this is needed, if it is always constructed then we'd better put it as a readonly field
        {
            get
            {
                if (_contractProvider == null)
                    _contractProvider = new CciContractProvider(_host, this.MetaDataDecoder, _contractDecoder);
        ...
        {
            get { return _contractDecoder; }
        }

        public CciMetadataDecoder MetaDataDecoder
        {
            get { return _metaDataDecoder; }
        }
        ...
        {
            return _contractDecoder.GetContextForMethodBody(method);
        }
        ...
        private IPrimarySourceLocation/*?*/ GetPrimarySourceLocation(CciILPC pc)
        {
            ...
            var primaryLocations = _metaDataDecoder.GetPrimarySourceLocationsFor(unit, pc.Operations, pc.RealIndex, false, out dummy);
        ...
        private IParameterTypeInformation Parameter(ref CciILPC pc)
        {
            ...
            if (result == null) result = _metaDataDecoder.This(MethodReferenceAdaptor.AdaptorOf(pc.Context.Method));
            return result;
        }
    ...
    internal class CciILPCMethodBodyWithContractContext : CciILPCContext
    {
          ...
          : base(method, operations)
        {
            ...
            if (0 < start)
                ...
                _firstPC = new CciILPC(this, end + 1);
        }
    ...
    internal class DummyReturnValueParameter : IParameterDefinition
    {
        ...
        public IEnumerable<ICustomAttribute> Attributes
        {
            get { return _containingMethod.ReturnValueAttributes; }
        }
        ...
        public bool IsModified
        {
            get { return _containingMethod.ReturnValueIsModified; }
        }
        ...
        public ITypeReference Type
        {
            get { return (_containingMethod.Type); }
        }
    ...
    {
        private readonly ITypeReference _thisType;

        internal DummyThisParameter(ITypeReference type)
        {
            _containingMethod = Dummy.Method;
            _thisType = type;
        }
    ...
    internal class DummyArrayMethodReference : IMethodReference
    {
        ...
        private readonly OperationCode _arrayOperation;
        private readonly IPlatformType _platformType;
        ...
        public IEnumerable<IParameterTypeInformation> Parameters
        {
            get
            {
                ushort n = (ushort)_arrayType.Rank;
                if (_arrayOperation == OperationCode.Array_Create_WithLowerBound) n *= 2;
                for (ushort i = 0; i < n; i++)
                    yield return new DummyArrayMethodParameter(this, i, _platformType.SystemInt32);
                if (_arrayOperation == OperationCode.Array_Set)
                    yield return new DummyArrayMethodParameter(this, n, _arrayType.ElementType);
            }
        }
        ...
        public ushort ParameterCount
        {
            get
            {
                ushort n = (ushort)_arrayType.Rank;
                if (_arrayOperation == OperationCode.Array_Create_WithLowerBound) n *= 2;
                if (_arrayOperation == OperationCode.Array_Set) n++;
                return n;
            }
        }
        ...
        {
            get { return _arrayOperation == OperationCode.Array_Addr; }
        }
        ...
        public ITypeReference Type
        {
            get
            {
                if (_arrayOperation == OperationCode.Array_Addr || _arrayOperation == OperationCode.Array_Get)
                    return (_arrayType.ElementType);
                else
                    return (_platformType.SystemVoid);
            }
        }
        ...
        {
            private readonly DummyArrayMethodReference _reference;
            ...
            public IEnumerable<IParameterDefinition> Parameters
            {
                get
                {
                    ushort n = (ushort)_reference._arrayType.Rank;
                    if (_reference._arrayOperation == OperationCode.Array_Create_WithLowerBound) n *= 2;
                    for (ushort i = 0; i < n; i++)
                        yield return new DummyArrayMethodParameter(this, i, _reference._platformType.SystemInt32);
                    if (_reference._arrayOperation == OperationCode.Array_Set)
                        yield return new DummyArrayMethodParameter(this, n, _reference._arrayType.ElementType);
                }
            }
            ...
            {
                get { return _reference.ContainingType.ResolvedType; }
            }
            ...
            public ITypeReference ContainingType
            {
                get { return _reference.ContainingType; }
            }
    ...
    internal class LambdaMethodReference : IMethodReference
    {
        ...
        private readonly IMethodReference _fakeMethodReferenceJustToGetInternedKey;
        ...
        internal LambdaMethodReference(IMetadataHost host, IAnonymousDelegate anonymousDelegate, string uniqueName)
        {
            ...
            var mr = new MethodReference(host,
              ...
              _host.NameTable.GetNameFor(name),
              0,
              paramTypes);
            _fakeMethodReferenceJustToGetInternedKey = mr;
        }
        ...
        public ITypeReference ContainingType
        {
            get { return _fakeMethodReferenceJustToGetInternedKey.ContainingType; } // BUGBUG: This says System.Object for all lambdas!
        }
        ...
        public IName Name
        {
            get { return _fakeMethodReferenceJustToGetInternedKey.Name; }
        }

        public uint InternedKey
        {
            get { return _fakeMethodReferenceJustToGetInternedKey.InternedKey; }
        }
        ...
        {
            private readonly LambdaMethodReference _reference;
            ...
            public bool IsStatic
            {
                get { return _reference.IsStatic; }
            }
            ...
            public IEnumerable<IParameterDefinition> Parameters
            {
                get
                {
                    foreach (var p in _reference.anonymousDelegate.Parameters)
                    {
                        yield return p;
                    }
                }
            ...
            public IEnumerable<ILocation> Locations
            {
                get { return _reference.Locations; }
            }
            ...
            public bool AcceptsExtraArguments
            {
                get { return _reference.AcceptsExtraArguments; }
            }

            public IEnumerable<IParameterTypeInformation> ExtraParameters
            {
                get { return _reference.ExtraParameters; }
            }

            public ushort GenericParameterCount
            {
                get { return _reference.GenericParameterCount; }
            }

            public uint InternedKey
            {
                get { return _reference.InternedKey; }
            }

            public bool IsGeneric
            {
                get { return _reference.IsGeneric; }
            }

            public ushort ParameterCount
            {
                get { return _reference.ParameterCount; }
            }
            ...
            public CallingConvention CallingConvention
            {
                get { return _reference.CallingConvention; }
            }

            IEnumerable<IParameterTypeInformation> ISignature.Parameters
            {
                get { return _reference.Parameters; }
            }

            public IEnumerable<ICustomModifier> ReturnValueCustomModifiers
            {
                get { return _reference.ReturnValueCustomModifiers; }
            }

            public bool ReturnValueIsByRef
            {
                get { return _reference.ReturnValueIsByRef; }
            }

            public bool ReturnValueIsModified
            {
                get { return _reference.ReturnValueIsModified; }
            }
    ...
    public class CciMetadataDecoder : IDecodeMetaData<LocalDefAdaptor, IParameterTypeInformation, MethodReferenceAdaptor, FieldReferenceAdaptor, IPropertyDefinition, IEventDefinition, TypeReferenceAdaptor, ICustomAttribute, IAssemblyReference>
    {
        internal CciMetadataDecoder(CciILCodeProvider parent, HostEnvironment host, IPlatformType platform)
        {
            ...
            _parent = parent;
            _host = host;
            _internFactory = host.InternFactory;
            _platform = platform ?? host.PlatformType;
        ...
        private readonly IPlatformType _platform;
        internal readonly MethodBodyCallback methodBodyCallback;
        private readonly Dictionary<MethodReferenceAdaptor, IParameterTypeInformation> _thisParameterFor = new Dictionary<MethodReferenceAdaptor, IParameterTypeInformation>();
        private readonly Dictionary<IUnitReference, ISourceLocationProvider> _unit2SourceLocationProvider = new Dictionary<IUnitReference, ISourceLocationProvider>();
        /// <summary>
        ...
        public bool IsPrimitive(TypeReferenceAdaptor type)
        {
            switch (type.TypeCode)
            {
                ...
                case PrimitiveTypeCode.IntPtr:
                    return true;
                default:
                    if (TypeHelper.TypesAreEquivalent(_platform.SystemDecimal, type.reference)) return true;
                    return false;
            }
        }
        ...
        private ITypeDefinition Specialize(INamedTypeDefinition typedef, ref int argStart, IEnumerable<ITypeReference> args)
        {
            ...
            {
                result = GenericTypeInstance.GetGenericTypeInstance((INamedTypeDefinition)result, args.Skip(argStart).Take(typedef.GenericParameterCount), _internFactory);
      ...
      return TypeReferenceAdaptor.AdaptorOf(gtir);
        ...
        public TypeReferenceAdaptor ArrayType(TypeReferenceAdaptor type, int rank)
        {
            ...
            if (rank == 1)
            {
                result = Microsoft.Cci.Immutable.Vector.GetVector(type.reference, _internFactory);
            }
            else
            {
                result = Microsoft.Cci.Immutable.Matrix.GetMatrix(type.reference, (uint)rank, _internFactory);
            }
            return TypeReferenceAdaptor.AdaptorOf(result);
        }
        ...
        {
            return TypeReferenceAdaptor.AdaptorOf(Microsoft.Cci.Immutable.ManagedPointerType.GetManagedPointerType(type.reference, _internFactory));
        }

        public TypeReferenceAdaptor UnmanagedPointer(TypeReferenceAdaptor type)
        {
            return TypeReferenceAdaptor.AdaptorOf(Microsoft.Cci.Immutable.PointerType.GetPointerType(type.reference, _internFactory));
        }
        ...
        public bool IsNativePointerType(TypeReferenceAdaptor type)
        {
            ...
            if (_platform.SystemIntPtr.InternedKey == type.InternedKey) return true;
            if (_platform.SystemUIntPtr.InternedKey == type.InternedKey) return true;
            return false;
        }
        ...
        public TypeReferenceAdaptor System_Array
        {
            get
            {
                return TypeReferenceAdaptor.AdaptorOf(_platform.SystemArray);
            }
        }

        public TypeReferenceAdaptor System_Boolean
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemBoolean); }
        }

        public TypeReferenceAdaptor System_Char
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemChar); }
        }
        ...
        public TypeReferenceAdaptor System_DynamicallyTypedReference
        {
            get
            {
                return TypeReferenceAdaptor.AdaptorOf(_platform.SystemTypedReference);
            }
        }
        ...
        public TypeReferenceAdaptor System_Double
        {
            get
            {
                return TypeReferenceAdaptor.AdaptorOf(_platform.SystemFloat64);
            }
        }
        ...
        public TypeReferenceAdaptor System_Decimal
        {
            get
            {
                return TypeReferenceAdaptor.AdaptorOf(_platform.SystemDecimal);
            }
        }
        ...
        public bool TryGetSystemType(string fullname, out TypeReferenceAdaptor type)
        {
            ...
            var coreAssemblyReference = new Microsoft.Cci.Immutable.AssemblyReference(_host, _host.CoreAssemblySymbolicIdentity);
            ...
            for (int i = 0, n = names.Length - 1; i < n; i++)
                ns = new Microsoft.Cci.Immutable.NestedUnitNamespaceReference(ns, _host.NameTable.GetNameFor(names[i]));
            var typeReference = new Microsoft.Cci.Immutable.NamespaceTypeReference(_host, ns, _host.NameTable.GetNameFor(names[names.Length - 1]), genericParameterCount, false, false, mangleName: (0 < genericParameterCount), typeCode: PrimitiveTypeCode.NotPrimitive);
        ...
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemInt8); }
        }

        public TypeReferenceAdaptor System_Int16
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemInt16); }
        }

        public TypeReferenceAdaptor System_Int32
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemInt32); }
        }

        public TypeReferenceAdaptor System_Int64
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemInt64); }
        }

        public TypeReferenceAdaptor System_IntPtr
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemIntPtr); }
        }

        public TypeReferenceAdaptor System_Object
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemObject); }
        }

        public TypeReferenceAdaptor System_RuntimeArgumentHandle
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemRuntimeArgumentHandle); }
        }

        public TypeReferenceAdaptor System_RuntimeFieldHandle
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemRuntimeFieldHandle); }
        }

        public TypeReferenceAdaptor System_RuntimeMethodHandle
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemRuntimeMethodHandle); }
        }

        public TypeReferenceAdaptor System_RuntimeTypeHandle
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemRuntimeTypeHandle); }
        }

        public TypeReferenceAdaptor System_Single
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemFloat32); }
        }

        public TypeReferenceAdaptor System_String
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemString); }
        }

        public TypeReferenceAdaptor System_Type
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemType); }
        }

        public TypeReferenceAdaptor System_UInt8
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemUInt8); }
        }

        public TypeReferenceAdaptor System_UInt16
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemUInt16); }
        }

        public TypeReferenceAdaptor System_UInt32
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemUInt32); }
        }

        public TypeReferenceAdaptor System_UInt64
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemUInt64); }
        }

        public TypeReferenceAdaptor System_UIntPtr
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemUIntPtr); }
        }

        public TypeReferenceAdaptor System_Void
        {
            get { return TypeReferenceAdaptor.AdaptorOf(_platform.SystemVoid); }
        }
        ...
        public TypeReferenceAdaptor ParameterType(IParameterTypeInformation p)
        {
            ...
            {
                result = Microsoft.Cci.Immutable.ManagedPointerType.GetManagedPointerType(result, _internFactory);
            }
        ...
        public TypeReferenceAdaptor LocalType(LocalDefAdaptor local)
        {
            ...
            {
                t = Microsoft.Cci.Immutable.ManagedPointerType.GetManagedPointerType(t, _internFactory);
            }
        ...
        private ISourceLocationProvider/*?*/ GetSourceLocationProvider(IUnitReference unit)
        {
            ...
            _unit2SourceLocationProvider.TryGetValue(unit, out sourceLocationProvider);
            ...
            if (assem != null)
            {
                ...
                if (File.Exists(pdbFile))
                {
                    using (Stream pdbStream = File.OpenRead(pdbFile)) // MB: no need to keep a lock on the PDB file
                        sourceLocationProvider = new PdbReader(pdbStream, _host);
                    _unit2SourceLocationProvider.Add(unit, sourceLocationProvider);
                }
            }
            return sourceLocationProvider;
        }
        ...
        {
            IUnit unit = _host.PossiblyCompileFirstLoadUnitFrom(fileName, referencedAssemblies, this.RegisterSourceLocationProvider);
            if (unit is Dummy) { assembly = null; return false; }
            assembly = unit as IAssembly;
            if (assembly == null)
                return false;

            var ce = _host.GetContractExtractor(unit.UnitIdentity);
      ...
      while (!references.IsEmpty())
      {
            ...
            if (!(implementingMethod is Dummy))
            {
                if (typeDef.IsGeneric && !(typeDef is Dummy))
                {
                    ...
                    var instant = Immutable.GenericTypeInstance.GetGenericTypeInstance((INamedTypeDefinition)typeDef,
                      ...
                      _host.InternFactory);
                    var method = instant.SpecializeMember(implementingMethod, _host.InternFactory);
        ...
        public IParameterTypeInformation This(MethodReferenceAdaptor methodAdaptor)
        {
            ...
            IParameterTypeInformation/*?*/ thisPar = null;
            if (!_thisParameterFor.TryGetValue(methodAdaptor, out thisPar))
            {
                Microsoft.Cci.MutableCodeModel.ParameterDefinition par = new Microsoft.Cci.MutableCodeModel.ParameterDefinition();
                par.Name = _host.NameTable.GetNameFor("this");
                ...
                {
                    par.Type = Microsoft.Cci.Immutable.ManagedPointerType.GetManagedPointerType(method.ContainingType, _internFactory);
                }
                else
                {
                ...
                //par.IsByReference = method.ContainingType.IsValueType;
                _thisParameterFor[methodAdaptor] = par;
                thisPar = par;
            }
            return thisPar;
        }
        ...
        {
            private IFieldReference/*?*/ _foundField;
            private FieldFinder() { }
        ...
        public IEnumerable<MethodReferenceAdaptor> ImplementedMethods(MethodReferenceAdaptor methodAdaptor)
        {
            ...
            var cd = _parent.ContractDecoder;
        ...
        public Result AccessMethodBody<Data, Result>(MethodReferenceAdaptor method, IMethodCodeConsumer<LocalDefAdaptor, IParameterTypeInformation, MethodReferenceAdaptor, FieldReferenceAdaptor, TypeReferenceAdaptor, Data, Result> consumer, Data data)
        {
            ...
            if (lambdaMethod != null)
            {
                ...
                return consumer.Accept<CciContractPC, CciExceptionHandlerInfo>(_parent.ContractProvider, contractPC, method, data);
            }
            else
            {
                return consumer.Accept<CciILPC, CciExceptionHandlerInfo>(_parent, _parent.Entry(method), method, data);
            }
        }
        ...
        private static ITypeReference DeclaringType(ITypeReference type)
        {
            var nested = type as INestedTypeReference;
        ...
        private static bool IsNestedFamily(ITypeDefinitionMember t)
        {
            var nested = t as INestedTypeDefinition;
            if (nested == null) return false;
            return (nested.Visibility == TypeMemberVisibility.Family);
        }
        private static bool IsNestedPublic(ITypeDefinitionMember t)
        {
            var nested = t as INestedTypeDefinition;
            if (nested == null) return false;
            return (nested.Visibility == TypeMemberVisibility.Public);
        }
        private static bool IsNestedAssembly(ITypeDefinitionMember t)
        {
            var nested = t as INestedTypeDefinition;
            if (nested == null) return false;
            return (nested.Visibility == TypeMemberVisibility.Assembly);
        }
        private static bool IsNestedFamilyAndAssembly(ITypeDefinitionMember t)
        {
            var nested = t as INestedTypeDefinition;
            if (nested == null) return false;
            return (nested.Visibility == TypeMemberVisibility.FamilyAndAssembly);
        }
        private static bool IsNestedFamilyOrAssembly(ITypeDefinitionMember t)
        {
            var nested = t as INestedTypeDefinition;
            if (nested == null) return false;
            return (nested.Visibility == TypeMemberVisibility.FamilyOrAssembly);
        }
        private static bool IsAssembly(ITypeDefinition t)
        {
            Contract.Requires(t != null);
            return !(TypeHelper.IsVisibleOutsideAssembly(t));
        }
        private static bool IsPublic(ITypeDefinition t)
        {
            Contract.Requires(t != null);
            return (TypeHelper.IsVisibleOutsideAssembly(t));
        }
        private static bool IsPublic(ITypeDefinitionMember member)
        {
        ...
        private static IUnitReference DeclaringModule(ITypeReference t)
        {
            Contract.Requires(t != null);
        ...
        {
            _host.AddLibPath(path);
        }

        public void AddResolvedPath(string path)
        {
            _host.AddResolvedPath(path);
        }
        ...
        private bool AsVisibleAs(ITypeMemberReference originalM1, ITypeMemberReference originalM2)
        {
        ...
        /// </summary>
        private bool AsVisibleAs(ITypeReference s1, ITypeMemberReference m2)
        {
        ...
        /// </summary>
        private bool AsVisibleAsUnspecialized(INamespaceTypeReference t1, ITypeMemberReference m2)
        {
        ...
        /// Assumes neither member is specialized
        /// </summary>
        private bool AsVisibleAsUnspecialized(ITypeMemberReference m1, ITypeMemberReference m2)
        {
        ...
        /// Assumes neither member is specialized
        /// </summary>
        private bool AsVisibleAsUnspecialized(IUnitReference a1, TypeMemberVisibility s1Visibility, ITypeReference m1Parent, ITypeReference m1AsType, ITypeMemberReference m2)
        {
        ...
        /// </summary>
        private bool AsRestrictiveAsOneLevel(IUnitReference a1, IUnitReference a2, TypeMemberVisibility s1Visibility, ITypeReference s1DeclaringType, ITypeReference s1AsType, TypeMemberVisibility s2Visibility, ITypeDefinitionMember s2)
        {
        ...
        private bool IsInsideOf(ITypeMemberReference member, ITypeReference type)
        {
            Contract.Requires(member != null);
        ...
        private bool IsInsideSubclassOf(ITypeMemberReference member, ITypeReference type)
        {
            Contract.Requires(member != null);
        ...
        private bool IsEqualOrDerivesFrom(ITypeReference t1, ITypeReference t2)
        {
        ...
        private IUnitReference AssemblyOf(ITypeReference typeReference)
        {
            Contract.Requires(typeReference != null);
            return TypeHelper.GetDefiningUnitReference(typeReference);
        }

        private IUnitReference AssemblyOf(ITypeMemberReference m)
        {
    ...
    public class IndexableCollection<ElementType> : IIndexable<ElementType>
    {
        ...
        {
            _elements = new List<ElementType>(elements);
        }
    ...
    {
        private readonly Function<FromType, ToType> _adapter;
        private readonly List<FromType> _elements;
        ...
        public IndexableCollection(IEnumerable<FromType> elements, Function<FromType, ToType> adapter)
        {
            ...
            _adapter = adapter;
            _elements = new List<FromType>(elements);
        }

        public int Count { get { return _elements.Count; } }
        public ToType this[int index]
        {
            get { return _adapter(_elements[index]); }
        }
    }

    public class TypeList : IIndexable<TypeReferenceAdaptor>
    {
        private readonly List<TypeReferenceAdaptor> _elements;
